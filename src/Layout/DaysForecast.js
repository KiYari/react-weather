        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12}>
            <Paper className={classes.contenter}>
              <Grid container>
                <Grid className={classes.castitem} item xs>
                  {this.state.today.getDate()}.{this.state.today.getMonth()+1}.
                  {this.state.today.getFullYear()}<br/>
                  Temperature(Kelvins) = {this.state.get_data[0][1]}<br/>
                  Conditionals = {this.state.get_data[0][2]}
                </Grid>
                <Grid className={classes.castitem} item xs>
                {this.state.today.getDate()+1}.{this.state.today.getMonth()+1}.
                {this.state.today.getFullYear()}<br/>
                Temperature(Kelvins) = {this.state.get_data[1][0]}<br/>
                Conditionals = {this.state.get_data[1][1]}
                </Grid>
                <Grid className={classes.castitem} item xs>
                {this.state.today.getDate()+2}.{this.state.today.getMonth()+1}.
                {this.state.today.getFullYear()}<br/>
                Temperature(Kelvins) = {this.state.get_data[2][0]}<br/>
                Conditionals = {this.state.get_data[2][1]}
                  </Grid>
                <Grid className={classes.castitem} item xs>
                {this.state.today.getDate()+3}.{this.state.today.getMonth()+1}.
                {this.state.today.getFullYear()}<br/>
                Temperature(Kelvins) = {this.state.get_data[3][0]}<br/>
                Conditionals = {this.state.get_data[3][1]}
                </Grid>
                <Grid className={classes.castitem} item xs>
                  {this.state.today.getDate()+4}.{this.state.today.getMonth()+1}.
                  {this.state.today.getFullYear()}<br/>
